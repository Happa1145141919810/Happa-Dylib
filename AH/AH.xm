...
[btn113 setTitle:@"进入应用(默认同意服务条款)" forState:UIControlStateNormal];//p1
...
[btn1133 setTitle:@"服务条款" forState:UIControlStateNormal];//p1
...
[btn1133 addTarget:self action:@selector(tos) forControlEvents:UIControlEventTouchUpInside];
...
[btn1131 setTitle:@"更多资源" forState:UIControlStateNormal];//p1
...
label313.text = @"For iOS 1145 - 2022 ©Happa";
