...
NSData *imageData = [NSData dataWithContentsOfURL:[NSURL URLWithString:@"https://www.ahfi.cn/tool/AHUI.png"]];
...
[btn113 setTitle:@"进入应用" forState:UIControlStateNormal];
...
[btn1133 setTitle:@"微信公众号" forState:UIControlStateNormal];
...
[btn1131 setTitle:@"加入交流群" forState:UIControlStateNormal];
...
label313.text = @"For iOS 2020 - 2022 ©阿辉";
...
+ (void)sure {
menuView.hidden = YES;
[[NSUserDefaults standardUserDefaults] setValue:@"Number.1" forKey:@"阿辉"];
[[NSUserDefaults standardUserDefaults] synchronize];
}


+ (void)chatgroup {
NSString *urlStr = [NSString stringWithFormat:@"https://vapp.vip/api/url/Tweak1.php"];
[[UIApplication sharedApplication] openURL:[NSURL URLWithString:urlStr]];
}


+ (void)wechat {
NSString *urlStr = [NSString stringWithFormat:@"https://vapp.vip/api/url/Tweak2.php"];
[[UIApplication sharedApplication] openURL:[NSURL URLWithString:urlStr]];
}
@end
